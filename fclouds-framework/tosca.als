// Generated at Sun Jun 28 13:22:37 CEST 2020 from  by org.eclipse.cmf.occi.core.gen.alloy
...
sig Tosca_nodes_root in core/Entity {
}
...
one sig tosca_nodes_dbms extends Mixin {} {
    ...
    depends = tosca_nodes_softwarecomponent + tosca_capabilities_container + platform/database
    no applies
...
one sig tosca_nodes_compute extends Mixin {} {
    ...
    scheme = "http://schemas.ogf.org/tosca/core#"
    title = "The TOSCA Compute node represents one or more real or virtual processors of software applications or services along with other essential local resources. Collectively, the resources the compute node represents can logically be viewed as a (real or virtual) “server”."
...
one sig tosca_nodes_loadbalancer extends Mixin {} {
    ...
    scheme = "http://schemas.ogf.org/tosca/core#"
    title = "The TOSCA Load Balancer node represents logical function that be used in conjunction with a Floating Address to distribute an application’s traffic (load) across a number of instances of the application (e.g., for a clustered or scaled application)."
...
sig Tosca_nodes_loadbalancer in platform/Component {
...
one sig tosca_relationships_root extends Mixin {} {
    ...
    depends = modmacao/installationdependency + modmacao/executiondependency
...
sig Tosca_relationships_root in platform/Componentlink {
